...
namespace Web_API.Controllers
{
    ...
    public class MissionController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("MissionApplicationPost")]

        public ResponseResult MissionApplicationPost([FromBody] MissionApplicationDTO missionApplication)
        {
            try
            {
                result.Data = _balMission.MissionApplicationPost(missionApplication);
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
