...
export class AdminsideServiceService {
  ...
  MissionApplicationDelete(id: any){
    return this.http.delete(`${this.apiUrl}/Mission/MissionApplicationDelete/${id}`);
  }

  MissionApplicationApprove(id: any){
    return this.http.put(`${this.apiUrl}/Mission/MissionApplicationApprove/${id}`,{});
  }
